...
class SequenceSynchronizedFramesEventsDataset(Dataset):
    ...
    def __init__(self, base_folder, event_folder, depth_folder='depth', frame_folder='rgb', flow_folder='flow', semantic_folder='events/voxels/',
...
class SynchronizedFramesEventsDataset(Dataset):
    ...
    * semantic is a 1 x H x W tensor containing the semantic labels 
    ...
    def __init__(self, base_folder, event_folder, depth_folder='depth', frame_folder='rgb', flow_folder='flow', semantic_folder='semantic',
